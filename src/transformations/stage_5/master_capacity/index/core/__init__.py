"""
index / core -- master capacity
===============================

Builds index_core_master_capacity, which feeds
...
subclass. Its workflow already exists and targets this exact folder:
    (stage5)master_capacity_index_core.yml
    python run.py --group master_capacity/index/core
