"""
index / rates -- master capacity
================================

Builds index_rates_master_capacity, which feeds
...
subclass. Its workflow already exists and targets this exact folder:
    (stage5)master_capacity_index_rates.yml
    python run.py --group master_capacity/index/rates
