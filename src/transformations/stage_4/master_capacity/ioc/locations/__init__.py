"""
ioc / locations -- master capacity
==================================

Builds ioc_locations_master_capacity, which feeds
...
subclass. Its workflow already exists and targets this exact folder:
    (stage5)master_capacity_ioc_locations.yml
    python run.py --group master_capacity/ioc/locations
