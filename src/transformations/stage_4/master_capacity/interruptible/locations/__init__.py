"""
interruptible / locations -- master capacity
============================================

Builds interruptible_locations_master_capacity, which feeds
...
subclass. Its workflow already exists and targets this exact folder:
    (stage5)master_capacity_interruptible_locations.yml
    python run.py --group master_capacity/interruptible/locations
