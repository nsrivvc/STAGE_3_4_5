"""
index / locations -- master capacity
====================================

Builds index_locations_master_capacity, which feeds
...
subclass. Its workflow already exists and targets this exact folder:
    (stage5)master_capacity_index_locations.yml
    python run.py --group master_capacity/index/locations
